...
require_once 'PEAR/ExceptionX.php';
...
class File_MARC extends File_MARCBASE
{
 ...
 throw new File_MARC_Exception(File_MARC_Exception::$messages[File_MARC_Exception::ERROR_DESCONOCIDO], File_MARC_Exception::ERROR_INVALID_TERMINATOR);
        }
