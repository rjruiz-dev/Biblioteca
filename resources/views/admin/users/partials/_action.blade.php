    ...
    @if ($usuarios['status_id'] == 3)
        @php 
        @endphp
        <a href="{{ $url_destroy }}" class="btn-delete" value="Baja"><i class="fa fa-arrow-down text-danger"></i></a> |  
       @php 
        @endphp
    @endif
    ...
    @if ($usuarios['status_id'] == 4)
        @php 
        @endphp
        <a href="{{ $url_destroy }}" class="btn-delete" value="Activar"><i class="fa fa-arrow-up text-green"></i></a> |  
       @php 
        @endphp
    @endif 
