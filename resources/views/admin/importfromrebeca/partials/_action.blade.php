...
@else
<a class="modal-show edit" id="btn-btn-edit" value="{{ $documentos->id }}" title="Asignar Tipo a Documento: {{ $documentos->id }}"><i class="fa fa-list text-success btn-btn-edit-user"></i></a> 
@endif    
