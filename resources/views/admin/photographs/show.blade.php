    ...
    <div class="col-md-6">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="col-md-12">  
                    <a href="{{ route('requests.solicitud', $photograph->document->id) }}" class="btn btn-danger btn-flat btn-block btn-solicitud" title="Solicitar Prestamo" type="button"><i class="fa fa-share-square-o"></i>&nbsp;Solicitar Prestamo</a>
                </div>
            </div>       
        </div>
    </div>
