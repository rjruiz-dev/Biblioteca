        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('creators_id', $authors, $movie->document['creators_id'], ['class' => 'form-control  select2', 'id' => 'creators_id', 'style' => 'width:100%;']) !!}
                </div> 
                <div class="form-group">
                    {!! Form::label('distribution', 'Reparto') !!}             
                    {!! Form::select('distribution', $distributions, null, ['class' => 'form-control  select2', 'id' => 'distribution', 'style' => 'width:100%;']) !!}
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('adaptations_id', $adaptations_bis, null, ['class' => 'form-control  select2', 'id' => 'adaptations_id', 'style' => 'width:100%;']) !!}
                </div> 
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('adequacies_id', $adaptations, $movie->document['adequacies_id'], ['class' => 'form-control  select2', 'id' => 'adequacies_id', 'style' => 'width:100%;']) !!}
                </div>
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('generate_films_id', $genders, null, ['class' => 'form-control  select2', 'id' => 'generate_films_id', 'style' => 'width:100%;']) !!}
                </div> 
                <div class="form-group">              
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">   
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('photography_movies_id', $photographs, null, ['class' => 'form-control  select2', 'id' => 'photography_movies_id', 'style' => 'width:100%;']) !!}
                </div> 
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('lenguages_id', $languages, $movie->document['lenguages_id'], ['class' => 'form-control  select2', 'id' => 'lenguages_id', 'style' => 'width:100%;']) !!}                     
                </div>

                <div class="form-group">
                    {!! Form::label('generate_references_id', 'Referencia') !!} 
                    {!! Form::select('generate_references_id', $references, $movie->document['generate_references_id'], ['class' => 'form-control  select2', 'id' => 'generate_references_id', 'style' => 'width:100%;']) !!}                     
                </div>
