...
<div class="panel panel-primary" style="border-color: {{ $setting->skin }};"> 
    ...
    <div class="row">           
                ...
                <div  class="col-md-4" style="margin-bottom:5px;">
                    ...
                    <a href="{{ route('admin.multimedias.create') }}"  id="btn-btn-create" class="btn btn-success pull-right modal-show" style=" display: none;" title="Crear Multimedia"><i class="fa fa-user-plus"></i> {{$ml_cat_list_book->multimedias_btn_crear}}</a>
                    @endif
