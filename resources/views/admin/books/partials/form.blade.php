        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('document_subtypes_id', $subtypes, $book->document['document_subtypes_id'], ['class' => 'form-control select2', 'id' => 'document_subtypes_id', 'onchange' => 'yesnoCheck()', 'style' => 'width: 100%']) !!}
                ...
                <!-- pub periodica / literiatura: cambia label solamente -->
                <div class="form-group">              
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('creators_id', $authors, $book->document['creators_id'], ['class' => 'form-control  select2', 'id' => 'creators_id', 'style' => 'width: 100%']) !!}
                </div> 
                <div class="form-group">
                    {!! Form::label('second_author_id', 'Segundo Artista') !!}             
                    {!! Form::select('second_author_id', $authors, null, ['class' => 'form-control  select2', 'id' => 'second_author_id', 'style' => 'width: 100%']) !!}
                </div>

                <div class="form-group" id="din_third_author_id"> 
                    {!! Form::label('third_author_id', 'Tercer Autor') !!}                    
                    {!! Form::select('third_author_id', $authors, null, ['class' => 'form-control select2', 'id' => 'third_author_id', 'style' => 'width: 100%']) !!}
                </div> 
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('adequacies_id', $adaptations, $book->document['adequacies_id'], ['class' => 'form-control  select2', 'id' => 'adequacies_id', 'style' => 'width: 100%']) !!}
                </div>
                <!-- lit o otros -->
              ...
              <!-- publicaicon periodica -->
                <div class="form-group" id="din_periodicities_id">                       
                        {!! Form::label('periodicities_id', 'Periodicidad') !!} 
                        {!! Form::select('periodicities_id', $periodicities, $book->periodical_publication['periodicities_id'], ['class' => 'form-control select2', 'id' => 'periodicities_id']) !!}                                      
                    </div>
                <!-- publicaicon periodica -->
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">   
                ...
                <div class="form-group">              
                    ...
                    {!! Form::select('made_by', $editorials, $book->document['made_by'], ['class' => 'form-control  select2', 'id' => 'made_by', 'style' => 'width: 100%']) !!}                            
                </div>            
                <div class="form-group">
                ...
                <div class="form-group">              
                    ...
                    {!! Form::select('edition', $editions, null, ['class' => 'form-control  select2', 'id' => 'edition', 'style' => 'width: 100%']) !!}                            
                </div>
                <div class="form-group">
                    {!! Form::label('volume', 'Volúmenes') !!}
                    {!! Form::select('volume', $volumes, $book->document['volume'], ['class' => 'form-control  select2', 'id' => 'volume', 'style' => 'width: 100%']) !!}            
                </div>
                <div class="form-group">                  
