...
<div class="form-group">               
        ...
        <div class="form-group">              
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('adequacies_id', $adaptations, $music->document['adequacies_id'], ['class' => 'form-control  select2', 'id' => 'adequacies_id']) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('generate_musics_id', 'Genero') !!}             
                    {!! Form::select('generate_musics_id', $genders, $music->generate_music['generate_musics_id'], ['class' => 'form-control  select2', 'id' => 'generate_musics_id']) !!}
                </div>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">   
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('lenguages_id', $languages, $music->document['lenguages_id'], ['class' => 'form-control  select2', 'id' => 'lenguages_id']) !!}                     
                </div>
                <div class="form-group">
