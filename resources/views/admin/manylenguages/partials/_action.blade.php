    ...
    <a href="{{ $url_edit_panel_admin }}" class="modal-show edit" id="btn-btn-edit" title="Editar: Panel Admin"><i class="fa fa-dashboard text-dark btn-btn-edit-user"></i></a> | 
    <a href="{{ $url_edit_front_end }}" class="modal-show edit" id="btn-btn-edit" title="Editar: Panel Cliente"><i class="fa fa-desktop text-dark btn-btn-edit-user"></i></a> | 
    ...
    <a href="{{ $url_edit_book }}" class="modal-show edit" id="btn-btn-edit" title="Catalogo Libros"><i class="fa fa-book text-dark btn-btn-edit-user"></i></a> | 
    <a href="{{ $url_edit_music }}" class="modal-show edit" id="btn-btn-edit" title="Catalogo Musica"><i class="fa fa-music text-dark btn-btn-edit-user"></i></a> | 
    <a href="{{ $url_edit_movie }}" class="modal-show edit" id="btn-btn-edit" title="Catalogo Cine"><i class="fa fa-video-camera text-dark btn-btn-edit-user"></i></a> | 
    <a href="{{ $url_edit_multimedia }}" class="modal-show edit" id="btn-btn-edit" title="Catalogo Multimedia"><i class="fa fa-youtube-play text-dark btn-btn-edit-user"></i></a> | 
    <a href="{{ $url_edit_fotografia }}" class="modal-show edit" id="btn-btn-edit" title="Catalogo Fotografia"><i class="fa fa-photo text-dark btn-btn-edit-user"></i></a> | 
