...
<body>
		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box dashboard-sideBar-UserInfo">
				<figure class="full-box">
					<img src="/adminlte/assets/avatars/AdminMaleAvatar.png" alt="UserIcon">
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					...
					<ul class="list-unstyled full-box">
						...
						<li>
							<a href="book.html"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Configuracion</a>
						</li>
					</ul>
				</li>
				<li>
			...
			<section id="cd-timeline" class="cd-container">
                <div class="cd-timeline-block">
                    <div class="cd-timeline-img">
                        <img src="/adminlte/assets/avatars/StudetMaleAvatar.png" alt="user-picture">
                    </div>
	...
	<!--====== Scripts -->
	<script src="/adminlte/js/jquery-3.1.1.min.js"></script>
	<script src="/adminlte/js/sweetalert2.min.js"></script>
	<script src="/adminlte/js/bootstrap.min.js"></script>
	<script src="/adminlte/js/material.min.js"></script>
	<script src="/adminlte/js/ripples.min.js"></script>
	<script src="/adminlte/js/jquery.mCustomScrollbar.concat.min.js"></script>
